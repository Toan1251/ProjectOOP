...
public class GroupDecreasePercent extends Group {
    ...
    public String begin(List<DataOutput> data) {
        ...
        addGroupSentences("Dẫn đầu nhóm giảm giá trong ngày là <rname> với mức giảm <rpercent>%, tương ứng giảm <rbegin> đồng/CP xuống còn <rend> đồng/CP, ngay sau đó là <rname2> với mức giảm <rpercent2>% ( <rbegin2> xuống <rend2> (đồng/CP) ),xếp thứ 3 là <rname3> giảm từ <rbegin3> đồng xuống <rend3> đồng/CP, tương ứng <rpercent3>%. Hai mã xếp cuối là trong top5 là <rname4> và <rname5>, giảm lần lượt <rpercent5>% và <rpercent6>%. ");
