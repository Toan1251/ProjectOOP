...
public class GroupTopPetrolVol extends Group {
    ...
    public String begin(List<DataOutput> data) {
        ...
        addGroupSentences("Nhóm dầu khí đáng chú ý có mã <PVname1> với lượng cố phiếu bán ra chiếm <timeP1>% của <totalP> cổ phiếu được bán ra, kế đến là <PVname2> bán được <PVnum2> cổ phiếu và <PVname3> với <PVnum3> cổ phiếu.");
        addGroupSentences("Bên cạnh đó, nhóm cổ phiếu dầu khí với <totalP> cổ phiếu được bán ra, <PVname1> chiếm <timeP1>%, tương đương <PVnum1> cổ phiếu, <PVname2> chiếm <timeP2>%, tương đương <PVnum2> cổ phiếu và <PVname3> chiếm <timeP3>%, tương đương <PVnum3> cổ phiếu.");
