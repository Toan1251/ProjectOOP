...
//        myList.add(filterByName(data,"C69"));
        ...
        for(int i=0;i<myList.size();i++){
            ...
            if(temp>0){
                ...
                map.put("openV"+(i+1),Long.toString((long)(myList.get(i).getData().getOpen()*1000000)));
                map.put("closeV"+(i+1),Long.toString((long)(myList.get(i).getData().getClose()*1000000)));
                map.put("numV"+(i+1),Long.toString((long)(Math.abs(temp)*1000000)));
            }
            else if(temp<0){
        ...
        for(int i=0;i<sortedListChange.size();i++) {
            ...
            if(temp>0){
                ...
                map.put("open"+(i+1),Long.toString((long)(sortedListChange.get(i).getData().getOpen()*1000000)));
                map.put("close"+(i+1),Long.toString((long)(sortedListChange.get(i).getData().getClose()*1000000)));
            }
            else if(temp<0){
