...
public class GroupPersonal extends Group {
    ...
    public List<String> Process(List<DataOutput> data, String name) {
        ...
        temp3.add("Bên cạnh đó, tổng khối lượng giao dịch của ngày hôm nay được thống kê là <volume1> cổ phiếu, đạt giá trị <gtgd> đồng , đây là một dấu hiệu <dauhieu>, khi ta đem so sánh với <nameSS> với <volume2> cổ phiếu thì nhận thấy rằng lượng cổ phiếu được bán ra <compare> <levelSS>. ");
