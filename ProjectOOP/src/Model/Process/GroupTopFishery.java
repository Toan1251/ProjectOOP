...
public class GroupTopFishery extends Group {
    ...
    public String begin(List<DataOutput> data) {
        ...
        addGroupSentences(" Bên cạnh đó, với việc tham gia các hiệp định thương mại thì nhóm ngành xuất khẩu như thủy sản cũng được đánh giá cao, nổi bật trong đó là <nameF1> đang dẫn đầu khi <Flink1> <level1> <numF1> đồng, ngay sau đó là <nameF2> <Flink2> <level2> <numF2> đồng.");
