...
public class GroupTopFisheryVol extends Group {
    ...
    public String begin(List<DataOutput> data) {
        ...
        addGroupSentences("Nhóm thủy sản đáng chú ý có mã <FVname1> với lượng cố phiếu bán ra chiếm <timeF1>% của <totalF> cổ phiếu được bán ra, kế đến là <FVname2> bán được <FVnum2> cổ phiếu và <FVname3> với <FVnum3> cổ phiếu.");
        addGroupSentences("Bên cạnh đó, nhóm cổ phiếu dầu khí với <totalF> cổ phiếu được bán ra, <FVname1> chiếm <timeF1>%, tương đương <FVnum1> cổ phiếu, <FVname2> chiếm <timeF2>%, tương đương <FVnum2> cổ phiếu và <FVname3> chiếm <timeF3>%, tương đương <FVnum3> cổ phiếu.");
